...
public class ImagePagerFragment extends Fragment {
   ...
   * it in parallel. In parallel, the background of the activity is fading in. When the pictue is in
   * place, the text description drops down.
   */
  ...
  /**
   * This is called by the colorizing animator. It sets a saturation factor that is then passed onto
   * a filter on the picture's drawable.
   *

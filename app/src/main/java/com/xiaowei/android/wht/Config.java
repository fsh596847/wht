...
public class Config {
  ...
  public static final String server = "http://www.yishenggonghui.com:8888/wcar/";
  //"http://112.74.27.10:8080/wcar/";
  /**
   * 用户注册认证登录 传入参数： mobile:手机号码; mcode:验证码 http:// www.yishenggonghui.com:8888/wht/phone_registUser.action
   * 返回正确结果： {"status":1,"data":{"id":"402881f254aec84e0154aecd73cd0002","url":"http://www.yishenggonghui.com:8888
   * /wht/phone_regMeet.action ","mobile":"13713981766"}}
   */
  public static final String registerUrl =
      "http://www.yishenggonghui.com:8888/wht/phone_registUser.action";
  /**
   * 获取验证码 传入参数： mobile:手机号码; http://www.yishenggonghui.com:8888/wht/phone_getmcode.action 返回正确结果：
   * {"status":1,"data":{"获取验证码成功"}}
   */
  public static final String getVerifyNoUrl =
      "http://www.yishenggonghui.com:8888/wht/phone_getmcode.action";
  /**
   * 首页地址 http://www.yishenggonghui.com:8888/wht/wap/meet_phoneIndex.action
   */
  public static final String indexUrl =
      "http://www.yishenggonghui.com:8888/wht/wap/meet_phoneIndex.action";
  /**
   * 登陆成功或是免登录跳转到的接口 传入参数： mobile:手机号码; userid:用户id meetid:会议id http://www.yishenggonghui.com:8888/wht/phone_regMeet.action
   */
  public static final String regMeetUrl =
  ...
  public static final String getYinlianPayUrl =
      "http://www.yishenggonghui.com:8888/wht/unionpay/unionpay_getPayInfo.action";

  public static final String crashFileRecvServer = "http://121.199.3.48:10080/hlpEC/";
  // 闪退日志文件接收服务器,当debug=false有效
  public static final String keyHttpUrlPref[] =
      new String[] {"http://www.yishenggonghui.com:8888/wcar/"};
  ...
  public static final String queryReferralAgreementUrl =
      SETTING + "/phone_queryReferralAgreement.action";
  ...
  public static final String getMeetWelcomeWord = SETTING + "/phone_getMeetWelcomeWord.action";
  //会议欢迎词信息
  public static final String getMeetBaseInfo = SETTING + "/phone_getMeetBaseInfo.action";//会议基本信息
  public static final String getMeetOrganizationals =
      SETTING + "/phone_getMeetOrganizationals.action";//组织结构
   ...
   * 查询患者转诊接口
   */
  public static final String queryPatientReferralUrl =
      SETTING + "/phone_queryPatientReferral.action";
  /**
   * 查询患者预约接口
   */
   ...
   * 预约支付宝支付
   */
  public static final String getBookingAppAliPayUrl =
      SETTING + "/alipay/alipay_getBookingAppAliPay.action";
  /**
   * 预约微信支付接口
   */
  public static final String getBookingAppPayUrl =
      SETTING + "/weixin/weixin_getBookingAppPay.action";
  /**
   * 医生社区
   */
   ...
   * 分享病例
   */
  public static final String shareCase =
      SETTING + "/phone_myCases.action?userid={USID}&type={TYPE}";
  /**
   * 我的评论
   */
  public static final String myComment =
      SETTING + "/phone_myReply.action?userid={USID}";
  /**
   * 邀请评论
   */
  public static final String inviteComment =
      SETTING + "/phone_myinvite.action?userid={USID}";
  /**
   * 打赏
   */

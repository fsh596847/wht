...
public class PatientMyInviteActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_patient_my_invite);
	...
	private void initListeners() {
		//返回
		findViewById(R.id.iv_patient_my_invite_back).setOnClickListener(new OnClickListener() {
		...
		//分享
		findViewById(R.id.rl_patient_my_invite_share).setOnClickListener(new OnClickListener() {
	...
	private void initViews() {
		...
		viewParent = (LinearLayout) findViewById(R.id.ll_patient_my_invite);
		
		//右滑退出
		SildingFinishLayout mSildingFinishLayout = (SildingFinishLayout) findViewById(R.id.sildingFinishLayout_patient_my_invite); 
		mSildingFinishLayout.setOnSildingFinishListener(new OnSildingFinishListener() {

			@Override
			public void onSildingFinish() {
				PatientMyInviteActivity.this.finish();
			}
		});
		// touchView
	...
	private void reload(String text){
		if (loadingDialog == null){
			loadingDialog = Utils.createLoadingDialog(PatientMyInviteActivity.this, text);
		}

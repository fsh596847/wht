...
/**
 * Created by HIPAA on 2016/11/24. 收藏病例s
 */

public class SaveCaseActivity extends BaseActivity {
  ...
  @Override public void init(Bundle savedInstanceState) {
    ...
    mWebView.addJavascriptInterface(new JavaScriptInterface(activity),
        "Android");
    mUrl = Config.shareCase.replace("{USID}", userid).replace("{TYPE}", "2");
  ...
  public class JavaScriptInterface {
    ...
    public void commentntent(String id) {//评论  详情
      Log.d(SaveCaseActivity.class.getSimpleName(), "commentntent" + id);

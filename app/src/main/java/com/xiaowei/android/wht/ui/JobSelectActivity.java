 ...
 * 
 * @author kevin
 * getIntent().getIntExtra("RESULTCODE", -1); 511;//职称 、512;//职务
 * setResult(RESULTCODE, new Intent().putExtra("result", "返回选择"));
 */
public class JobSelectActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//右滑退出
		SildingFinishLayout mSildingFinishLayout = (SildingFinishLayout) findViewById(R.id.sildingFinishLayout_job_title); 

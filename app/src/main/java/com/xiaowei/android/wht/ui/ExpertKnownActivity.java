...
public class ExpertKnownActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//右滑退出
		SildingFinishLayout mSildingFinishLayout = (SildingFinishLayout) findViewById(R.id.sildingFinishLayout_expert); 
		mSildingFinishLayout.setOnSildingFinishListener(new OnSildingFinishListener() {

			@Override
			public void onSildingFinish() {
				ExpertKnownActivity.this.finish();
			}
		});
		// touchView
	...
	private void initView() {
		...
		lvExpert = (ListView) findViewById(R.id.listview_expert);
		expertAdapter = new MyExpertAdapter(ExpertKnownActivity.this,lvExpert);
		...
		lvExpert.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				startActivity(new Intent(ExpertKnownActivity.this,ExpertInforActivity.class)
		...
		findViewById(R.id.iv_expert_back).setOnClickListener(new OnClickListener() {
	...
	private boolean isFinish;
		...
		private void reload(String text){
			if (loadingDialog == null){
				loadingDialog = Utils.createLoadingDialog(ExpertKnownActivity.this, text);
			}

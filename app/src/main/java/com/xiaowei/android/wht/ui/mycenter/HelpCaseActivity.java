...
public class HelpCaseActivity extends BaseActivity {
  ...
  @Override public void init(Bundle savedInstanceState) {
    ...
    mWebView.addJavascriptInterface(new JavaScriptInterface(activity),
        "Android");
    mUrl = Config.shareCase.replace("{USID}", userid).replace("{TYPE}", "1");
  ...
  public class JavaScriptInterface {
    ...
    public void commentntent(String id) {//评论  详情
      Log.d(HelpCaseActivity.class.getSimpleName(), "commentntent" + id);

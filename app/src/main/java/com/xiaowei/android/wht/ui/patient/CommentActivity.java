...
import com.xiaowei.android.wht.ui.doctorzone.PaySelectTyepActivity;
import com.xiaowei.android.wht.ui.doctorzone.ReportActivity;
import com.xiaowei.android.wht.ui.doctorzone.RotationSampleActivity;
...
/**
 * Created by HIPAA on 2016/11/24.  患者病例详情
 */
...
public class CommentActivity extends BaseActivity implements AlertDialog.CallPayType {
  ...
  @Override public void init(Bundle savedInstanceState) {
    ...
    mUrl = Config.issueCaseDetailePatient.replace("{userid}", mUserid)
        .replace("{id}", mCaseId);
    Log.d(CommentActivity.class.getSimpleName(), mUrl);
  ...
  public class JavaScriptInterface {
    ...
    @JavascriptInterface
    public void patientHeadInfo(String doctorid) {//评论  详情

...
public class BaseAdapterHelper {
  ...
  public BaseAdapterHelper setTextSpann(@IdRes int viewId, CharSequence value, int appearance,
      int start, int end) {
    TextView view = retrieveView(viewId);
    view.setText(value);
    SpannableString styledText = new SpannableString(value);
    styledText.setSpan(new TextAppearanceSpan(context, appearance), start, end,
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setImageResource(@IdRes int viewId, int imageResId) {
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setBackgroundColor(@IdRes int viewId, int color) {
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setBackgroundRes(@IdRes int viewId, int backgroundRes) {
    View view = retrieveView(viewId);
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setTextColor(@IdRes int viewId, int textColor) {
    TextView view = retrieveView(viewId);
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setTextColorRes(@IdRes int viewId, int textColorRes) {
    TextView view = retrieveView(viewId);
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setImageDrawable(@IdRes int viewId, Drawable drawable) {
    ImageView view = retrieveView(viewId);
   ...
   * It uses Square's Picasso library to download the image asynchronously and put the result into
   * the ImageView.<br/>
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setImageUrl(@IdRes int viewId, String imageUrl) {
    ImageView view = retrieveView(viewId);
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setImageBuilder(@IdRes int viewId, RequestCreator requestBuilder) {
    ImageView view = retrieveView(viewId);
  ...
  public BaseAdapterHelper setImageBitmap(@IdRes int viewId, Bitmap bitmap) {
    ImageView view = retrieveView(viewId);
   ...
   * Alpha between 0-1.
   */
  public BaseAdapterHelper setAlpha(@IdRes int viewId, float value) {
  ...
  public BaseAdapterHelper setTypeface(@IdRes int viewId, Typeface typeface) {
    TextView view = retrieveView(viewId);
  ...
  public BaseAdapterHelper setTypeface(Typeface typeface, @IdRes int... viewIds) {
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setOnClickListener(@IdRes int viewId, View.OnClickListener listener) {
    View view = retrieveView(viewId);
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setOnTouchListener(@IdRes int viewId, View.OnTouchListener listener) {
    View view = retrieveView(viewId);
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setOnLongClickListener(@IdRes int viewId,
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setOnCheckedChangeListener(@IdRes int viewId,
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setTag(@IdRes int viewId, Object tag) {
    View view = retrieveView(viewId);
    view.setTag(tag);
    return this;
  }
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setTag(@IdRes int viewId, int key, Object tag) {
    View view = retrieveView(viewId);
    view.setTag(key, tag);
    return this;
  }
   ...
   * @return The BaseAdapterHelper for chaining.
   */
  public BaseAdapterHelper setAdapter(@IdRes int viewId, Adapter adapter) {
    AdapterView view = retrieveView(viewId);
  ...
  @SuppressWarnings("unchecked") protected <T extends View> T retrieveView(@IdRes int viewId) {
    ...
    if (view == null) {
      ...
      if (view != null) {
        ...
        throw new RuntimeException("the view of " + viewId + " is not found in item layout.");
      }
    }
    return (T) view;
  }
